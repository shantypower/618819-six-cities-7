...
function CommentForm(props) {
  ...
  const handleTextareaChange = (event) => setValue({
    ...value,
    text: Number(event.target.value),
  });
  ...
  const handleFormSubmit = (evt) => {
    evt.preventDefault();
    //const reviewText = new FormData(textareaRef.current).get('review');
  };


  return (
    <form className="reviews__form form" action="#" method="post" onSubmit={handleFormSubmit} ref={textareaRef}>
      ...
      <textarea className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" defaultValue = {props.text || ''} onChange={handleTextareaChange}></textarea>
